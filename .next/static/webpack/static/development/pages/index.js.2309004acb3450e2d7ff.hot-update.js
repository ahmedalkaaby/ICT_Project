...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    className: "w-4/12 flex items-center ml-4 justify-start",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "w-4/12 mr-4 flex justify-end",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44
    },
    ...
    className: "w-full bg-darkblue h-16 text-white text=sm md:text-md font-semibold flex justify-center items-center text-center m-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 51
    },
...
//# sourceMappingURL=index.js.2309004acb3450e2d7ff.hot-update.js.map