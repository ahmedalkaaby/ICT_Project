...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    id: "footer",
    className: "flex flex-col md:flex-row w-full h-64 text-white text-sm lg:text-base xl:text-xl py-10 m-auto items-center justify-around bg-blue-900",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 5
    },
...
//# sourceMappingURL=index.js.7cfaf9cddd01e546cf23.hot-update.js.map