...
var Footer = function Footer() {
  return __jsx("div", {
    ...
    id: "footer",
    className: "flex flex-col md:flex-row w-full h-auot md:h-64 text-white text-sm lg:text-base xl:text-xl py-10 m-auto items-center justify-around bg-blue-900",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 5
    },
    ...
    className: "w-full md:w-4/12 flex flex-col md:flex-row items-center md:ml-4 justify-start",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "flex flex-col md:flex-row w-full md:w-4/12 items-center justify-center",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 19
    },
    ...
    className: "w-full md:w-4/12 md:mr-4 flex justify-center md:justify-end",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 44
    },
...
//# sourceMappingURL=index.js.b1ff787662c84615a49b.hot-update.js.map